...
# Set window for 2 x 2 square of four combined plots 

par(mfrow=c(2,2))
par(mar=c(4.5, 4.5, 0.5, 0.5))

# Create first of four combined plots

with(electric_power_consumption,plot(datetime,Global_active_power,
                                     type = "l",main = "", xlab = "",
                                     ylab = "Global Active Power (kilowatts)"))

# Create second of four combined plots

with(electric_power_consumption,plot(datetime,Voltage, type = "l", col = "black"))

# Create third of four combined plots
...
# Create fourth of four combined plots

with(electric_power_consumption,plot(datetime,Global_reactive_power, type = "l", col = "black"))
